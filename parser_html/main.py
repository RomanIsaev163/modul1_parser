...
from parser_funcs import get_flows, get_flow_page_news, parse_flow, pase_flows, get_article_content, get_articles_content, get_article_content, get_articles_content
...
flows_cards_df = pase_flows(flow_df['flow_link'].values, get_flow_news_args)
